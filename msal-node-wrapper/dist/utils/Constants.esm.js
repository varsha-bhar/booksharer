...
'use strict';
import { OIDC_DEFAULT_SCOPES } from '../node_modules/@azure/msal-common/dist/utils/Constants.esm.js';
import { LogLevel } from '../node_modules/@azure/msal-common/dist/logger/Logger.esm.js';
...
const OIDC_SCOPES = [...OIDC_DEFAULT_SCOPES, "email"];
/**
...
export { AccessControlConstants, AppStages, ConfigurationErrorMessages, DEFAULT_LOGGER_OPTIONS, EMPTY_STRING, ErrorMessages, OIDC_SCOPES };
